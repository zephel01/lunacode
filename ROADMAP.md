...
- **完了 Phase**: 23 / 全 24（Phase 19 のみ保留）
- **テスト**: 676 pass / 0 fail
...
### Phase 24.1.6: サンドボックス CLI

`lunacode sandbox list / diff / merge / clean` コマンド。現状は API のみ提供中。
Tier 1 のマージ UX を手元から扱いやすくする。

### Phase 25〜: サンドボックス Tier 2 / Tier 3
