<p align="center">
  ...
  <p align="center">
    ...
    <img alt="Tests: 471 pass" src="https://img.shields.io/badge/tests-471%20pass-brightgreen.svg" />
    <img alt="Phase: 17/17" src="https://img.shields.io/badge/phase-17%2F17%20complete-success.svg" />
  </p>
  <p align="center">
...
```bash
# 全テスト実行
bun test  # 471 pass / 0 fail / 976 expect()
...
| [開発計画](./docs/inside/plan.md) | 全17フェーズの詳細・進捗 |
