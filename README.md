<p align="center">
  ...
  <p align="center">
    ...
    <img alt="Tests: 676 pass" src="https://img.shields.io/badge/tests-676%20pass-brightgreen.svg" />
    <img alt="Phase: 23/24" src="https://img.shields.io/badge/phase-23%2F24%20complete-success.svg" />
  </p>
  <p align="center">
...
全 24 フェーズ中 23 完了（Phase 19 bubbletea のみ保留）。
...
```bash
# 全テスト実行
bun test  # 676 pass / 0 fail / 1468 expect()
