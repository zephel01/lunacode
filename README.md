<p align="center">
  ...
  <p align="center">
    ...
    <img alt="Tests: 566 pass" src="https://img.shields.io/badge/tests-566%20pass-brightgreen.svg" />
    <img alt="Phase: 21/22" src="https://img.shields.io/badge/phase-21%2F22%20complete-success.svg" />
  </p>
  <p align="center">
...
全 22 フェーズ中 21 完了（Phase 19 bubbletea は保留、Phase 22 未着手）。
...
```bash
# 全テスト実行
bun test  # 566 pass / 0 fail / 1166 expect()
